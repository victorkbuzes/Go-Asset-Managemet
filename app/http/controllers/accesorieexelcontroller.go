...
type ExelAccesorieCreateReq struct {
	ID           uint      `json:"id"`
...
type ExelAccesorieController struct {
	DB *sql.DB
}

// 0722157344

func (c *ExelAccesorieController) Index(ctx *fiber.Ctx) error {
...
func (c *ExelAccesorieController) CreateAccesorie(ctx *fiber.Ctx) error {
...
func (c *ExelAccesorieController) GetAccesorie(ctx *fiber.Ctx) error {
...
func (c *ExelAccesorieController) UpdateAccesorie(ctx *fiber.Ctx) error {
...
func (c *ExelAccesorieController) DeleteAccesorie(ctx *fiber.Ctx) error {
	id, _ := strconv.Atoi(ctx.Params("id"))
