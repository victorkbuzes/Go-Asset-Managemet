...
type ExelAssetController struct {
	DB *sql.DB
}
type ExelCreateAssetReq struct {
	ID           uint      `json:"id"`
...
func (c *ExelAssetController) Index(ctx *fiber.Ctx) error {
...
func (c *ExelAssetController) CreateAsset(ctx *fiber.Ctx) error {

	var assetReq ExelCreateAssetReq
	...
	if assetReq.CategorieID == 1 {
		categorie.Title = "Laptops"
	}
...
func (c *ExelAssetController) GetAsset(ctx *fiber.Ctx) error {
...
func (c *ExelAssetController) UpdateAsset(ctx *fiber.Ctx) error {
...
func (c *ExelAssetController) DeleteAsset(ctx *fiber.Ctx) error {
	id, _ := strconv.Atoi(ctx.Params("id"))
